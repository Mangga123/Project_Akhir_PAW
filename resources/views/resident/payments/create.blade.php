            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('resident.payments.store', $bill->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <!-- Input File dengan style standar agar tidak membingungkan -->
                    ...
                    <div class="flex items-center justify-between mt-8">
                        ...
                        <button type="submit" class="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg shadow-md transition duration-150 ease-in-out transform hover:-translate-y-0.5">
                            Kirim Bukti Bayar 🚀
                        </button>
                    </div>
                </form>
